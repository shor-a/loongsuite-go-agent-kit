...
func init() {
	TestCases = append(TestCases,
		NewGeneralTestCase("eino-react-agent-test", eino_module_name, "v0.7.13", "", "1.24", "", TestReactAgentEino),
		NewGeneralTestCase("eino-openai-invoke-test", eino_module_name, "v0.7.13", "", "1.24", "", TestOpenAIInvokeEino),
		NewGeneralTestCase("eino-openai-stream-test", eino_module_name, "v0.7.13", "", "1.24", "", TestOpenAIStreamEino),
		NewGeneralTestCase("eino-ollama-invoke-test", eino_module_name, "v0.7.13", "", "1.24", "", TestOllamaInvokeEino),
		NewGeneralTestCase("eino-ollama-stream-test", eino_module_name, "v0.7.13", "", "1.24", "", TestOllamaStreamEino),
		NewGeneralTestCase("eino-ark-invoke-test", eino_module_name, "v0.7.13", "", "1.24", "", TestArkInvokeEino),
		NewGeneralTestCase("eino-ark-stream-test", eino_module_name, "v0.7.13", "", "1.24", "", TestArkStreamEino),
		NewGeneralTestCase("eino-claude-invoke-test", eino_module_name, "v0.7.13", "", "1.24", "", TestClaudeInvokeEino),
		NewGeneralTestCase("eino-claude-stream-test", eino_module_name, "v0.7.13", "", "1.24", "", TestClaudeStreamEino),
		...
		NewMuzzleTestCase("eino-muzzle-test-react-agent", eino_dependency_name, eino_module_name, "v0.7.13", "", "1.24", "", []string{"go", "build", "test_react_agent.go", "eino_common.go"}),
		NewMuzzleTestCase("eino-muzzle-test-openai-invoke", eino_dependency_name, eino_module_name, "v0.7.13", "", "1.24", "", []string{"go", "build", "test_openai_invoke_chatmodel.go", "eino_common.go"}),
		NewMuzzleTestCase("eino-muzzle-test-openai-stream", eino_dependency_name, eino_module_name, "v0.7.13", "", "1.24", "", []string{"go", "build", "test_openai_stream_chatmodel.go", "eino_common.go"}),
